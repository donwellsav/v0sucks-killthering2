  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Mobile: Controls + Issues panel (default view) */}
        ...
        {/* Main visualization area — graph takes full height on desktop */}
        <main className={`flex-1 flex flex-col overflow-hidden min-w-0 ${mobileShowGraph ? 'flex' : 'hidden lg:flex'}`}>
          {/* Large Panel — full height except for mobile pill switcher */}
