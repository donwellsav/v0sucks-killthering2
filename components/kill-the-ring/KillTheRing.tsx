  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex w-56 xl:w-64 2xl:w-72 flex-shrink-0 border-r border-border bg-card/50 flex-col overflow-hidden">
        ...
        <main className={`flex-1 flex flex-col overflow-hidden min-w-0 ${mobileShowGraph ? 'flex' : 'hidden lg:flex'}`}>
          ...
          <div className="flex lg:hidden items-center gap-2 px-2 pb-1.5 pt-0.5 flex-shrink-0">
            {GRAPH_CHIPS.map((chip) => (
              <button
                key={chip.value}
                onClick={() => setActiveGraph(chip.value)}
          ...
          <div className="hidden lg:flex flex-[2] min-h-0 gap-1.5 lg:gap-2 p-1.5 lg:p-3 pt-0.5 lg:pt-1">
