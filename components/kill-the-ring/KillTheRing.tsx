              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="relative h-full aspect-square flex items-center justify-center flex-shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full"
                  >
                    <div className={`absolute inset-[3px] rounded-full border-2 transition-colors duration-300 ${isRunning ? 'border-primary' : 'border-primary/50'}`} />
                    {isRunning && (
                      <div className="absolute inset-[3px] rounded-full border-2 border-primary animate-ping opacity-30" />
                    )}
                    <svg
